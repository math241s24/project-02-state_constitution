...
*Establish a process to scrape the individual constitutions from state 
government websites and convert them into tidy data frames, excluding all text 
from the website not in the constitution (Basil-Anne)
...
*Create Website with interactive maps and write up (Basil-Anne and Katie)
